...
class TFBackend(BaseFock):
    ...
    def begin_circuit(self, num_subsystems, **kwargs):
        ...
        with tf.compat.v1.name_scope('Begin_circuit'):
    ...
    def reset(self, pure=True, **kwargs):
        ...
        with tf.compat.v1.name_scope('Reset'):
            self._modemap.reset()
    ...
    def prepare_vacuum_state(self, mode):
        with tf.compat.v1.name_scope('Prepare_vacuum'):
    ...
    def prepare_thermal_state(self, nbar, mode):
        with tf.compat.v1.name_scope('Prepare_thermal'):
            remapped_mode = self._remap_modes(mode)
    ...
    def displacement(self, alpha, mode):
        with tf.compat.v1.name_scope('Displacement'):
            remapped_mode = self._remap_modes(mode)
    ...
    def beamsplitter(self, t, r, mode1, mode2):
        with tf.compat.v1.name_scope('Beamsplitter'):
    ...
    def measure_fock(self, modes, shots=1, select=None, **kwargs):
        ...
        with tf.compat.v1.name_scope('Measure_fock'):
    ...
    def del_mode(self, modes):
        with tf.compat.v1.name_scope('Del_mode'):
            remapped_modes = self._remap_modes(modes)
    ...
    def add_mode(self, n=1):
        with tf.compat.v1.name_scope('Add_mode'):
